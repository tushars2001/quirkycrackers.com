...
<html>
	<head>
		...
		<meta name="keywords" 			content="rarest of rare, usa, united states, laden, osama, obama, einstine, usa history, us history, gandhi, nehru, dhoni, dhoni boy, bhagat singh">
		<meta name="description" 		content="I bet you have not seen most of these rare pictures.">
		<meta property="og:title"   	content="Rarest of Rare History Pictures" />
		...
		<cfelse>
			<meta property="og:image"       content="http://quirkycrackers.com/quirkycrackers/history-in-pictures/history.jpg" /> 
			<meta property="og:description" content="I bet you have not seen most of these rare pictures." /> 
		</cfif>
		...
		<script>
			...
			$(".goog_ad_top").append(g3);
		    	if (!cssua.ua.mobile) {
				 ...
				 $(".goog_ad_desktop").width(($(window).width()-$(".img_img").width()));
  ...
  fjs.parentNode.insertBefore(js, fjs);
	  ...
	  ga('send', 'pageview');
		...
		<cfoutput>
			...
			<table style="text-align:center;align:center;width:100%;">
				...
				<tr><td>
					...
					<cfelse>
						<span style="border-left:5px solid white;"><a href="../indian-history-in-pictures/?utm_source=usa-history&utm_medium=next&utm_campaign=indiahistory">Next Post</a></span>
					</cfif>
					<span><div class="fb-share-button" data-href="http://quirkycrackers.com/quirkycrackers/history-in-pictures/?utm_source=share_from_site&utm_medium=fb_share&utm_campaign=world-history" data-layout="button_count"></div></span>
				...
				<tr>
					<td>
						...
						<span><div class="fb-share-button" data-href="http://quirkycrackers.com/quirkycrackers/history-in-pictures/?id=#url.id#&shared_pic=1&utm_source=share_from_site&utm_medium=fb_share&utm_campaign=world-history" data-layout="button_count"></div></span>
						<span><div class="fb-like" data-href="http://quirkycrackers.com/quirkycrackers/history-in-pictures/?id=#url.id#&shared_pic=1&utm_source=share_from_site&utm_medium=fb_share&utm_campaign=world-history" data-layout="button_count" data-action="like" data-show-faces="false" data-share="false"></div></span>
					</td>
				</tr>
		...
		<!----<div style="width:100%;text-align:center;max-height:200px;overflow:auto;">
			<cfoutput><div class="fb-comments" data-href="http://quirkycrackers.com/quirkycrackers/history-in-pictures/?id=#url.id#&shared_pic=1&utm_source=share_from_site&utm_medium=fb_share&utm_campaign=rarenamo" data-numposts="5"></div></cfoutput>
		</div>----->
		<div id="preview">
			<div >
				<ol>
