...
<html>
	<head><meta http-equiv="Content-Type" content="text/html; charset=windows-1252">
		...
		<cfset next = url.id + 1>
		<cfquery name="getall" datasource="product" <!--- cachedwithin="#createtimespan(5,0,0,0)#" --->>
			select * from qc_links_inventions
		</cfquery>
		...
		<meta name="keywords" 			content="inventions, india, indian, india history, indian history, gandhi, nehru, dhoni, dhoni boy, bhagat singh">
		<meta name="description" 		content="So, we’ve always been a cool country. History is testimony to it. So what’s stopping you from being innovative? Go, win the world.">
		<meta property="og:title"   	content="20 Clever Inventions by Indians" />
		<cfif url.shared_pic eq 1>
			<cfoutput>
				<meta property="og:image"       content="#current.link#" /> 
				<meta property="og:title" content='Clever Indian Inventions : #current.title#' /> 
				<meta property="og:description" content='#current.description#' /> 
			</cfoutput>
		<cfelse>
			<meta property="og:image"       content="http://quirkycrackers.com/quirkycrackers/clever-inventions-by-indians/history.jpg" /> 
			<meta property="og:description" content="So, we have always been a cool country. History is testimony to it. So what is stopping you from being innovative? Go, win the world." /> 
		</cfif>
		    	...
		    	if (!cssua.ua.mobile) {
				 ...
				 var g1 = '<script async src="//pagead2.googlesyndication.com/pagead/js/adsbygoogle.js"><\/script>'
					...
					var g2 = '		<script async src="//pagead2.googlesyndication.com/pagead/js/adsbygoogle.js"><\/script>'
							...
							+'(adsbygoogle = window.adsbygoogle || []).push({});'
							+'<\/script>';
					var g3 = '<script async src="//pagead2.googlesyndication.com/pagead/js/adsbygoogle.js"><\/script>'
								+'	<ins class="adsbygoogle"'
									+'     style="display:inline-block;width:125px;height:125px;float: right;"'
									  +'   data-ad-client="ca-pub-9042848322034372"'
				  ...
				  setTimeout(function(){
				  	$($(".goog_ad_desktop")[1]).append(g2);
				  	 setTimeout(function(){
					  	$($(".goog_ad_small")[0]).append(g3);
					  },500);
					  setTimeout(function(){
					  	$($(".goog_ad_small")[1]).append(g3);
					  },700);
				  },1000);
  ...
  fjs.parentNode.insertBefore(js, fjs);
	  ...
	  ga('send', 'pageview');
		...
		<cfoutput>
			...
			20 Clever Inventions by Indians
			</div>
			<div style="width:100%;text-align:center;font-size:small;color:white;background-color:blue;">
			<a style="text-decoration:none;color:white;" href="http://quirkycrackers.com/quirkycrackers/indian-history-in-pictures/?utm_source=clever-inventions&utm_medium=website&utm_campaign=indiahistory">Rarest of Rare Indian History Pics (200+)</a>
			</div>
			...
			<table style="text-align:center;align:center;width:100%;">
				...
				<tr><td>
					...
					<cfelse>
						<span style="border-left:5px solid white;"><a href="../indian-history-in-pictures/?utm_source=clever-inventions&utm_medium=next&utm_campaign=indiahistory">Next</a></span>
					</cfif>
					<span><div class="fb-share-button" data-href="http://quirkycrackers.com/quirkycrackers/clever-inventions-by-indians/?utm_source=share_from_site&utm_medium=fb_share&utm_campaign=indiainventions" data-layout="button"></div></span>
				...
				<tr>
					<td style="font-size:x-large;">#current.rank#. #current.title#</td>
				</tr>
				<tr>
				...
				<tr>
					<td style="border:1px dotted red;"><span style="width:50%">#current.description#</span></td>
				</tr>
				<tr>
					<td>
						Like or Share This Invention
						<span><div class="fb-share-button" data-href="http://quirkycrackers.com/quirkycrackers/clever-inventions-by-indians/?id=#url.id#&shared_pic=1&utm_source=share_from_site&utm_medium=fb_share&utm_campaign=indiainventions" data-layout="button"></div></span>
						<span><div class="fb-like" data-href="http://quirkycrackers.com/quirkycrackers/clever-inventions-by-indians/?id=#url.id#&shared_pic=1&utm_source=share_from_site&utm_medium=fb_share&utm_campaign=indiainventions" data-layout="button" data-action="like" data-show-faces="false" data-share="false"></div></span>
					</td>
				</tr>
						...
						<div class="topcont">
							<div id="previewtop">
								...
								<cfloop from="#url.id+1#" to="#url.id+3#" index="idx">
									<span title="#getall.link[idx]#" ><a href="./?id=#getall.record_id[idx]#"><img src="#getall.link[idx]#"  class="resize" style="vertical-align:middle"></a></span>
									<!--- <cfif idx eq 5>
		...
		<!----<div style="width:100%;text-align:center;max-height:200px;overflow:auto;">
			<cfoutput><div class="fb-comments" data-href="http://quirkycrackers.com/quirkycrackers/clever-inventions-by-indians/?id=#url.id#&shared_pic=1&utm_source=share_from_site&utm_medium=fb_share&utm_campaign=indiainventions" data-numposts="5"></div></cfoutput>
		</div>----->
		<div id="preview">
			<div >
				<ol>
			<cfoutput query="getall">
				<li><span style="font-size:small;"><a href="./?id=#getall.record_id#">#getall.title#<!--- <img src="#getall.description#"  class="resize"> ---></a></span></li>
			</cfoutput>
			</ol>
			<!--- <div>
				<script async src="//pagead2.googlesyndication.com/pagead/js/adsbygoogle.js"></script>
