...
<html>
	<head>
		...
		<link rel="stylesheet"  href="https://cdnjs.cloudflare.com/ajax/libs/ion-rangeslider/2.1.2/css/ion.rangeSlider.min.css"></link>
		<link rel="stylesheet"  href="https://cdnjs.cloudflare.com/ajax/libs/ion-rangeslider/2.1.2/css/ion.rangeSlider.skinModern.min.css"></link>
		...
		<script>
		    ...
		    $(".img").css("max-width",$(window).width());
		     ...
		     $("#rank_slider").css("max-width","600px");
		     
		     
		     $("#ranking").ionRangeSlider({
			    min: 0,
			    max: 10,
			    from: 6,
			    from_min: 1,
			    ...
			    onStart: function (data) {
			    	setTimeout(function(){
			    		$("#rank_count").css({"top":$(".js-irs-0").position().top+20,"left":$(".js-irs-0").position().left+200});
			    		$("#rank_count").show();
			    	},2000);
			...
			$(".js-irs-0").width("200px");
			$(".js-irs-0").css("left",($(window).width()-200)/2);
...
<script>(function(d, s, id) {
  ...
  fjs.parentNode.insertBefore(js, fjs);
	  ...
	  <cfoutput>ga('create', 'UA-54318348-1x', 'auto');</cfoutput>
		...
		<cfoutput>
			...
			<table style="text-align:center;align:center;width:100%;">
				<tr><td>
					...
					<br>
					<span><div class="fb-share-button" data-href="http://quirkycrackers.com/quirkycrackers/indian-history-in-pictures/?utm_source=share_from_site&utm_medium=fb_share&utm_campaign=indiahistory" data-layout="button_count"></div></span>
				...
				<tr>
					<td>
						<span id="rank_slider"><input id="ranking" type="text" name="ranking"></span>
						<span id="rank_count" style="position:absolute;display:none;">12345</span>
					</td>
				</tr>
				<tr>
				...
				<tr>
					<td>
						...
						<span><div class="fb-share-button" data-href="http://quirkycrackers.com/quirkycrackers/indian-history-in-pictures/?id=#url.id#&shared_pic=1&utm_source=share_from_site&utm_medium=fb_share&utm_campaign=indiahistory" data-layout="button_count"></div></span>
