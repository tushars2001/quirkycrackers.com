...
<html>
	<head>
		...
		<meta name="keywords" 			content="narendra modi, rarest of rare, india, indian, india history, indian history, gandhi, nehru, dhoni, dhoni boy, bhagat singh">
		<meta name="description" 		content="I bet you have not seen most of these rare pictures of Narendra Modi.">
		<meta property="og:title"   	content="Rarest of Rare Narendra Modi" />
		<cfif url.shared_pic eq 1>
			<cfoutput>
				<meta property="og:image"       content="#current.link#" /> 
				<meta property="og:description" content='Narendra Modiji ki Life. In Pictures.' /> 
			</cfoutput>
		<cfelse>
			<meta property="og:image"       content="http://quirkycrackers.com/quirkycrackers/narendra-modi-in-pictures/history.jpg" /> 
			<meta property="og:description" content="I bet you have not seen most of these rare pictures of Narendra Modi" /> 
		</cfif>
...
<script>(function(d, s, id) {
  ...
  js.src = "//connect.facebook.net/en_US/sdk.js#xfbml=1&version=v2.5&appId=585706938226278";
  fjs.parentNode.insertBefore(js, fjs);
	  ...
	  ga('send', 'pageview');
		...
		<cfoutput>
			...
			Rarest of Rare : Narendra Modi
			</div>
			<div style="width:100%;text-align:center;font-size:small;color:white;background-color:blue;">
			<a style="text-decoration:none;color:white;" href="http://quirkycrackers.com/quirkycrackers/clever-inventions-by-indians/?utm_source=indian-history&utm_medium=website&utm_campaign=rarenamo">20 Clever Indian Inventions</a>
			</div>
			<div style="width:100%;text-align:center;font-size:small;color:red;background-color:yellow;">
			<a style="text-decoration:none;color:red;font-weight:bold;" href="http://quirkycrackers.com/quirkycrackers/indian-history-in-pictures/?utm_source=clever-inventions&utm_medium=website&utm_campaign=indiahistory">Rarest of Rare Indian History Pics (200+)</a>
			</div>
			...
			<table style="text-align:center;align:center;width:100%;">
				...
				<tr><td>
					...
					<cfelse>
						<span style="border-left:5px solid white;"><a href="../indian-history-in-pictures/?utm_source=clever-inventions&utm_medium=next&utm_campaign=indiahistory">Next Post</a></span>
					</cfif>
					<span><div class="fb-share-button" data-href="http://quirkycrackers.com/quirkycrackers/narendra-modi-in-pictures/?utm_source=share_from_site&utm_medium=fb_share&utm_campaign=rarenamo" data-layout="button"></div></span>
				...
				<tr>
					<td>
						...
						<span><div class="fb-share-button" data-href="http://quirkycrackers.com/quirkycrackers/narendra-modi-in-pictures/?id=#url.id#&shared_pic=1&utm_source=share_from_site&utm_medium=fb_share&utm_campaign=rarenamo" data-layout="button"></div></span>
						<span><div class="fb-like" data-href="http://quirkycrackers.com/quirkycrackers/narendra-modi-in-pictures/?id=#url.id#&shared_pic=1&utm_source=share_from_site&utm_medium=fb_share&utm_campaign=rarenamo" data-layout="button" data-action="like" data-show-faces="false" data-share="false"></div></span>
					</td>
				</tr>
				...
				<tr>
					<td>
						<div class="topcont">
							...
							<div style="text-align:center;width:100%;height:100px;max-height:100px;">
								<script async src="//pagead2.googlesyndication.com/pagead/js/adsbygoogle.js"></script>
								<!-- FTB_ADAPT_2 -->
								<ins class="adsbygoogle"
								     style="display:block"
		...
		<!----<div style="width:100%;text-align:center;max-height:200px;overflow:auto;">
			<cfoutput><div class="fb-comments" data-href="http://quirkycrackers.com/quirkycrackers/narendra-modi-in-pictures/?id=#url.id#&shared_pic=1&utm_source=share_from_site&utm_medium=fb_share&utm_campaign=rarenamo" data-numposts="5"></div></cfoutput>
		</div>----->
		<!--- <div id="preview">
			<div >
				<ol>
			<cfoutput query="getall">
				<li><span style="font-size:small;"><a href="./?id=#getall.record_id#">#getall.description#<!--- <img src="#getall.description#"  class="resize"> ---></a></span></li>
			</cfoutput>
			</ol>
			<!--- <div>
				<script async src="//pagead2.googlesyndication.com/pagead/js/adsbygoogle.js"></script>
			...
			<!--- <cfoutput query="getall">
				<span title="#getall.description#"><a href="./?id=#getall.record_id#"><img src="#getall.description#"  class="resize"></a></span>
			</cfoutput> --->
			</div>
		</div> --->
		<div style="height:25px"></div>
		<div style="width:90%;text-align:center;border-bottom:5px solid white;font-size:x-small;">Hosted at: <a href="http://www.quirkycrackers.com/?utm_source=modiji_qc&utm_medium=self&utm_campaign=rarenamo" >QuirkyCrackers</a> | Supported By: <a href="http://www.findtrackbuy.com/?utm_source=modiji_ftb&utm_medium=self&utm_campaign=rarenamo" >FindTrackBuy</a> | <!--- <a href= "https://www.facebook.com/sufyan.sadiq"> --->FB Credit - Rahul Singla<!--- </a> ---></div>
...
<div class="slider" style="width:300px">
			...
			<cfoutput query="slider">
					...
					<cfelse>
						...
						<div id="slider_#slider.idproduct_main#" class="slideContent" style="position:relative;display:block;border:0px solid black;;text-align:center;">
								<!--- <div style="position:fixed;top:100px;left:0;">#slider.title#</div> --->
								<a href="http://www.quirkycrackers.com/?utm_source=modiji_qc&utm_medium=self&utm_campaign=rarenamo" target="_blank" onclick="clickLog(#slider.idproduct_main#);">
				...
				<!--- <div id="slider_1" class="slideContent" style="position:relative;display:block;border:0px solid black;;text-align:center;">
					<a href="http://www.quirkycrackers.com/?utm_source=modiji_qc&utm_medium=self&utm_campaign=rarenamo" target="_blank">
...
<!--- <div id="preview2">
				<!--- <ul>
			<cfoutput query="getall">
				<li><span title="#getall.description#"><a href="./?id=#getall.record_id#">#getall.description#<!--- <img src="#getall.description#"  class="resize"> ---></a></span></li>
			</cfoutput>
			</ul> --->
			<cfoutput query="getall">
