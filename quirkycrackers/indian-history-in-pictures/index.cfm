...
<cflocation addtoken="false" url="http://blog.quirkycrackers.com/indian-history-in-pictures/?id=#url.id#">
<!DOCTYPE html>
...
<html>
	<head>
		...
		<meta name="keywords" 			content="india, indian, india history, indian history, gandhi, nehru, dhoni, dhoni boy, bhagat singh">
		...
		<meta property="fb:app_id" content="585706938226278" />
  ...
  fjs.parentNode.insertBefore(js, fjs);
	  ...
	  ga('send', 'pageview');
		...
		<cfoutput>
			...
			<div style="width:100%;text-align:center;font-size:small;color:white;background-color:##FF9933;">
			<a target="_blank" style="text-decoration:none;color:white;" href="http://goo.gl/B2JYfh">MOTO E2 3G : @Rs 3994/- First/Last Time</a>
			</div>
			
			<div style="width:100%;text-align:center;font-size:small;color:blue;background-color:white;">
			<a target="_blank" style="text-decoration:none;color:red;font-weight:bold;" href="http://goo.gl/B2JYfh">MOTO E2 4G : @Rs 4929/- First/Last Time</a>
			</div>
			
			
			<div style="width:100%;text-align:center;font-size:small;color:white;background-color:##138808;">
			<a target="_blank" style="text-decoration:none;color:white;font-weight:bold;" href="http://goo.gl/3rzr2c">SUPER R-Day DEALS of 2016 @ Amazon</a>
			</div>
			...
			On Mobile, tap image for actual size.
			</div>
				</td></tr>
				<tr>
					...
					<td class="img" style="color:white;text-align:center;overflow: hidden;">
						<table style="width:100%;text-align:center;">
							<tr>
								...
								<td>
									<img onclick="enlarge();" src="#current.description#" class="img_img">
								</td>
								<td>
									<div class="goog_ad_desktop">
				...
				<tr>
					<td>
						...
						<span><div class="fb-like" data-href="http://quirkycrackers.com/quirkycrackers/indian-history-in-pictures/?id=#url.id#&shared_pic=1&utm_source=share_from_site&utm_medium=fb_share&utm_campaign=indiahistory" data-layout="button" data-action="like" data-show-faces="false" data-share="false"></div></span>
					</td>
				</tr>
		...
		<div id="preview">
			...
			<cfoutput query="getall">
				<li><span style="font-size:small;"><a href="./?id=#getall.record_id#">#getall.link#<!--- <img src="#getall.description#"  class="resize"> ---></a></span></li>
			</cfoutput>
			</ol>
			<!--- <div>
				<script async src="//pagead2.googlesyndication.com/pagead/js/adsbygoogle.js"></script>
		...
		<div style="width:100%;text-align:center;font-size:small;color:white;background-color:blue;">
			<a style="text-decoration:none;color:white;" href="http://quirkycrackers.com/quirkycrackers/clever-inventions-by-indians/?utm_source=indian-history&utm_medium=website&utm_campaign=indiainventions">20 Clever Indian Inventions</a>
			</div>
			
			<div style="width:100%;text-align:center;font-size:small;color:red;background-color:yellow;">
			<a style="text-decoration:none;color:red;font-weight:bold;" href="http://quirkycrackers.com/quirkycrackers/narendra-modi-in-pictures/?utm_source=indian-history&utm_medium=website&utm_campaign=indiahistory">NaMo's Life in Pictures (100+)</a>
			</div>
			...
			<div style="width:100%;text-align:center;font-size:small;color:red;background-color:yellow;">
			<a style="text-decoration:none;color:red;font-weight:bold;" href="http://quirkycrackers.com/quirkycrackers/rarest-of-rare-sachin/?utm_source=indian-history&utm_medium=website&utm_campaign=indiahistory">Rarest of RARE Sachin</a>
			</div>
